...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        ...
        var pageId = "page-" + (window.location.pathname.split('/').pop() ||
            'home');
        return (React.createElement(ThemeProvider, { options: getTheme(this.state.theme), className: "app__root", tag: "div", id: pageId },
            React.createElement(AppBar, { onNavClick: function (evt) {
                    return _this.setState({ menuIsOpen: !_this.state.menuIsOpen });
                } }, !this.state.isMobile && (React.createElement(ThemePicker, { selectedThemeName: this.state.theme, onThemeClick: function (themeName) {
            ...
            React.createElement("div", { className: "demo-content" },
                React.createElement(Nav, { open: this.state.menuIsOpen, dismissible: !this.state.isMobile, modal: this.state.isMobile, onClose: function () { return _this.setState({ menuIsOpen: false }); } }),
