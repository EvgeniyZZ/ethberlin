...
var LinearProgressRoot = base_1.componentFactory({
...
var LinearProgress = /** @class */ (function (_super) {
        ...
        return new linear_progress_1.MDCLinearProgressFoundation({
            ...
            getPrimaryBar: function () {
                return _this.root.ref &&
                    _this.root.ref.querySelector(linear_progress_1.MDCLinearProgressFoundation.strings.PRIMARY_BAR_SELECTOR);
            },
            getBuffer: function () {
                return _this.root.ref &&
                    _this.root.ref.querySelector(linear_progress_1.MDCLinearProgressFoundation.strings.BUFFER_SELECTOR);
            },
    ...
    LinearProgress.prototype.render = function () {
        ...
        if (determinate !== undefined) {
            base_1.deprecationWarning('LinearProgress determinate is no longer a valid prop. Determinate is set automatically be the presence of the progress prop.');
        }
