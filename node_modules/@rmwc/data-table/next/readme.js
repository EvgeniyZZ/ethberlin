...
export default function () {
    return (React.createElement(Docs, { title: "Data Tables", lead: "Data tables display sets of data.", module: "@rmwc/data-table", styles: ['@rmwc/data-table/data-table.css'], examples: examples, addon: true },
        ...
        React.createElement(DocsExample, null, function Example() {
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement(DataTable, { style: { height: '300px', width: '375px' }, 
                    // @ts-ignore
                    stickyRows: rows, 
                    // @ts-ignore
                    stickyColumns: cols },
                ...
                React.createElement("div", null,
                    "Sticky",
                    React.createElement(Select, { label: "Rows", options: ['0', '1'], value: String(rows), onChange: function (evt) { return setRows(evt.currentTarget.value); } }),
                    React.createElement(Select, { label: "Cols", options: ['0', '1'], value: String(cols), onChange: function (evt) { return setCols(evt.currentTarget.value); } }))));
        }),
        ...
        React.createElement(DocsExample, null, function Example() {
            ...
            return (React.createElement(DataTable, null,
                React.createElement(DataTableContent, null,
                    React.createElement(DataTableHead, null,
                        React.createElement(DataTableRow, null,
                            React.createElement(DataTableHeadCell, null,
