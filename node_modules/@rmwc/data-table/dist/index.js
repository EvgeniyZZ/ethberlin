...
exports.DataTable = base_1.componentFactory({
...
var DataTableSortIcon = function () { return (React.createElement(icon_1.Icon, { className: "rmwc-data-table__sort-icon", icon: React.createElement("svg", { width: "18", height: "18", viewBox: "0 0 24 24" },
        React.createElement("path", { fill: "currentColor", d: "M20 12l-1.41-1.41L13 16.17V4h-2v12.17l-5.58-5.59L4 12l8 8 8-8z" })) })); };
var DataTableHeadCellRoot = base_1.componentFactory({
...
exports.DataTableHeadCell = function (props) {
...
exports.DataTableCell = base_1.componentFactory({
...
var SimpleDataTable = /** @class */ (function (_super) {
    ...
    SimpleDataTable.prototype.render = function () {
        ...
        return (React.createElement(exports.DataTable, __assign({}, rest),
            React.createElement(exports.DataTableContent, null,
                !!headers && (React.createElement(exports.DataTableHead, null, headers.map(function (row, i) { return (React.createElement(exports.DataTableRow, __assign({ key: i }, getRowProps(row, i, true)), row.map(function (cell, j) { return (React.createElement(exports.DataTableHeadCell, __assign({ key: j }, getCellProps(cell, j, true)), cell)); }))); }))),
                React.createElement(exports.DataTableBody, null, data.map(function (row, i) { return (React.createElement(exports.DataTableRow, __assign({ key: i }, getRowProps(row, i, false)), row.map(function (cell, j) { return (React.createElement(exports.DataTableCell, __assign({ key: j }, getCellProps(cell, j, false)), cell)); }))); })))));
    };
