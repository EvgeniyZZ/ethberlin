...
/** The DataTable Component. */
export declare const DataTable: React.ComponentType<RMWC.MergeInterfacesT<DataTableProps, RMWC.ComponentProps>>;
/** The data table content. */
export interface DataTableContentProps {
}
/** The data table content. */
export declare const DataTableContent: React.ComponentType<RMWC.MergeInterfacesT<DataTableContentProps, RMWC.ComponentProps>>;
/** A header for the data table. */
export interface DataTableHeadProps {
}
/** A header for the data table. */
export declare const DataTableHead: React.ComponentType<RMWC.MergeInterfacesT<DataTableHeadProps, RMWC.ComponentProps>>;
/** A body for the data table. */
export interface DataTableBodyProps {
}
/** A body for the data table. */
export declare const DataTableBody: React.ComponentType<RMWC.MergeInterfacesT<DataTableBodyProps, RMWC.ComponentProps>>;
...
/** A row for the data table. */
export declare const DataTableRow: React.ComponentType<RMWC.MergeInterfacesT<DataTableRowProps, RMWC.ComponentProps>>;
...
export declare const DataTableHeadCell: {
    (props: DataTableHeadCellProps & RMWC.ComponentProps): JSX.Element;
    displayName: string;
};
...
/** A cell for the DataTable */
export declare const DataTableCell: React.ComponentType<RMWC.MergeInterfacesT<DataTableCellProps, RMWC.ComponentProps>>;
...
/** A simple data table to render matrices. */
export declare class SimpleDataTable extends React.Component<SimpleDataTableProps> {
    render(): JSX.Element;
}
export {};
