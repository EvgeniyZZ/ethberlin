...
exports.TabScrollerRoot = base_1.componentFactory({
    displayName: 'TabScroller',
    classNames: ['mdc-tab-scroller']
});
exports.TabScrollerScrollArea = base_1.componentFactory({
    displayName: 'TabScrollerScrollArea',
    classNames: ['mdc-tab-scroller__scroll-area']
});
exports.TabScrollerScrollContent = base_1.componentFactory({
...
var TabScroller = /** @class */ (function (_super) {
    ...
    TabScroller.prototype.getDefaultFoundation = function () {
        ...
        return new tab_scroller_1.MDCTabScrollerFoundation({
            eventTargetMatchesSelector: function (evtTarget, selector) {
                return base_1.matches(evtTarget, selector);
            },
    ...
    TabScroller.prototype.render = function () {
        ...
        return (React.createElement(exports.TabScrollerRoot, __assign({}, this.root.props(rest), { ref: this.root.setRef }),
            React.createElement(exports.TabScrollerScrollArea, __assign({}, this.area.props({}), { ref: this.area.setRef, onWheel: this.handleInteraction, onTouchStart: this.handleInteraction, onPointerDown: this.handleInteraction, onMouseDown: this.handleInteraction, onKeyDown: this.handleInteraction }),
                React.createElement(exports.TabScrollerScrollContent, __assign({}, this.content.props({}), { ref: this.content.setRef, onTransitionEnd: this.handleTransitionEnd }), children))));
    };
    return TabScroller;
