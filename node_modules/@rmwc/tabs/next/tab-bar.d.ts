...
export declare class TabBar extends FoundationComponent<MDCTabBarFoundation, TabBarProps> {
    ...
    tabList: any[];
    contextApi: {
        onTabInteraction: (evt: MDCTabInteractionEvent) => void;
        registerTab: (tab: React.ComponentType<import("./tab").TabProps & RMWC.ComponentProps & {
            contextApi?: import("./tab-bar-context").TabBarContextT | undefined;
        }>) => number;
        unregisterTab: (tab: React.ComponentType<import("./tab").TabProps & RMWC.ComponentProps & {
            contextApi?: import("./tab-bar-context").TabBarContextT | undefined;
        }>) => any[];
    };
