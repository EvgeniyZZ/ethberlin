...
exports.TopAppBarNavigationIcon = ripple_1.withRipple({
    unbounded: true,
    surface: false
...
exports.TopAppBarActionItem = ripple_1.withRipple({
    unbounded: true,
    surface: false
})(base_1.componentFactory({
    ...
    TopAppBarBase.prototype.getDefaultFoundation = function () {
        ...
        var adapter = {
            ...
            notifyNavigationIconClicked: function () {
                _this.emit(top_app_bar_1.MDCTopAppBarFoundation.strings.NAVIGATION_EVENT, {});
            },
